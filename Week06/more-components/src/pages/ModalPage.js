...
export default function ModalPage() {
  ...
  const actionBar = (
  <>
    <Button danger onClick={() => console.log('clicked the danger button')} className='margin mr-5'>Delete</Button>
...
const modal = (
  ...
  this is a very important modal for us to accept or decline
  </Modal>
  )
